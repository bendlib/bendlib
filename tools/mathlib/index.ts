...
for (const file of files) {
  ...
  for (const l of laws) if (l.name.endsWith("_sym")) twins++; else lemmas++;
...
out.push(...body, `${lemmas} lemmas + ${twins} generated _sym twins, ${predicates} predicates. Generated by \`tools/mathlib/index.ts\`.`, "");
...
console.log(`wrote ${target} (${lemmas} lemmas + ${twins} twins, ${predicates} predicates)`);
